...
* Login as "admin"
* On Config repo page
* Verify that the page contains all of "cr, cr1_1, cr2_2, cr3_3, cr4_4"
...
* On Config repo page
* Verify that the page contains all of "cr1_1"
...
* On Config repo page
* Verify that the page contains all of "cr2_2"
...
* On Config repo page
* Verify that the page contains all of "cr3_3"
...
* On Config repo page
* Verify that the page contains all of "cr, cr1_1, cr2_2, cr4_4"
...
* On Config repo page
* Verify that the page contains all of ""
