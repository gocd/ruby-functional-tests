...
* Verify plugin with identifier "plugin-with-multiple-load-methods.jar" is marked as invalid with message "Class [PluginWithMultipleLoadMethods] is annotated with @Extension will not be registered. Reason: java.lang.RuntimeException: More than one method with @Load annotation not allowed."
