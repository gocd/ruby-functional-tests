...
* Verify plugin with id "com.example.elasticagent.foocloud" has path "/plugins/external/elastic-agent-skeleton-plugin.jar" supported OS "No restrictions" target go version "18.12.0" and bundled status as "No"
