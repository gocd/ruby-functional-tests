...
* Verify plugin with identifier "Yum Plugin" has path "/plugins/external/gocd-yum-repository-poller-plugin.jar" supported OS "Linux" target go version "15.2.0" and bundled status as "No"
