...
* Click on add user permission - add "view" permission for "user4"
* Click on add user permission - add "operate" permission for "user5"
...
* Verify that user "user5" is inherited
...
* Verify that user "user5" is already added - On Permission tab
...
* Add new user permission
* Set "user4" as user name - On Permission tab
* Save Changes
* Verify message "User \"user4\" who is not authorized to operate pipeline group `basic` can not be authorized to approve stage" shows up - On Permission tab
* Reset Changes
* Open "Permissions" tab - On Stage settings page
...
* Delete users "user4,user5" from DB
