...
* Verify modification "0" has revision "$grandparent-fast$/2/defaultStage/1" - On Build Cause popup
* Verify material has changed - On Build Cause popup
* Looking at material of type "Pipeline" named "$parent-fast$"
* Verify modification "0" has revision "$parent-fast$/2/defaultStage/1" - On Build Cause popup
* Verify material has changed - On Build Cause popup
* Looking at material of type "Pipeline" named "$parent-slow$"
* Verify modification "0" has revision "$parent-slow$/2/defaultStage/1" - On Build Cause popup
* Verify material has changed - On Build Cause popup
* Looking at material of type "Git" named "$git-five$"
* Verify modification "0" has revision "g2" - On Build Cause popup
* Verify material has changed - On Build Cause popup
