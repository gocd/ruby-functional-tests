...
* Using pipeline "trackingtool-config-parent, pipeline-with-trackingtool" - setup
...
* With material "pipeline-git" of type "git" for pipeline "pipeline-with-trackingtool"
...
* Verify displays revision "$trackingtool-config-parent$/2/defaultStage/1" having label "hello-world-2" under pipeline named "$trackingtool-config-parent$"
